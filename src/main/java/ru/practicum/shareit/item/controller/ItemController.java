...
public class ItemController {
    ...
    @GetMapping("/{itemId}")
    public ResponseEntity<ItemResponseDto> getById(@RequestHeader("X-Sharer-User-Id") Long userId,
                                                   @PathVariable Long itemId) {
        return ResponseEntity.ok(service.getById(userId, itemId));
    }

    @GetMapping
    public ResponseEntity<List<ItemResponseDto>> getOwnerItems(@RequestHeader("X-Sharer-User-Id") Long userId,
